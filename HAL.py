...
from Knight_Anything import *
from Archer_Anything import *
from Wizard_Anything import *
...
def run():
    ...
    blue_knight = Knight_Anything(world, blue_knight_image, blue_base, Vector2(blue_base.spawn_position))
    ...
    blue_archer = Archer_Anything(world, blue_archer_image, blue_arrow_image, blue_base, Vector2(blue_base.spawn_position))
    ...
    blue_wizard = Wizard_Anything(world, blue_wizard_image, blue_rock_image, blue_base, Vector2(blue_base.spawn_position), blue_explosion_image)
